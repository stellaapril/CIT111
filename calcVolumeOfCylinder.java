...
public class calcVolumeOfCylinder {
    ...
    public static double calcVolumnOfCylinder(double cylinderRadius,double cylinderHeight){
        double cylinderVolume = cylinderRadius*cylinderRadius*cylinderHeight;
